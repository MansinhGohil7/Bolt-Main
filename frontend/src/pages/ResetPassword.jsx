  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError('');
        // Save token to localStorage if returned, or just redirect
        if (data.token) {
      ...
      <div className="max-w-md w-full mx-auto px-margin-mobile relative z-10">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <motion.div layout variants={itemVariants} className="flex flex-col gap-2">
              <label className="font-label-md text-label-md uppercase tracking-widest text-on-surface-variant text-xs" htmlFor="confirmPassword">
